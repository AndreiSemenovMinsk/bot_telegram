...
public interface FilterPointRepository extends JpaRepository<FilterPointEntity, Integer> {
    ...
    Optional<FilterPointEntity> findByCategory_IdAndNameRU(Integer categoryId, String name);

    Optional<FilterPointEntity> findByCategory_IdAndNameEN(Integer categoryId, String name);

    Optional<FilterPointEntity> findByCategory_IdAndNameDE(Integer categoryId, String name);
    ...
    Optional<FilterPointEntity> findByCategory_IdAndUnitNameRU(Integer categoryId, String unitName);

    Optional<FilterPointEntity> findByCategory_IdAndUnitNameEN(Integer categoryId, String unitName);

    Optional<FilterPointEntity> findByCategory_IdAndUnitNameDE(Integer categoryId, String unitName);

    List<FilterPointEntity> findAllByCategory_Id(Integer categoryId);

    FilterPointEntity save(FilterPointEntity filterPoint);

    default Optional<FilterPointEntity> findByCategoryAndName_LocaleAndName_Text(Integer categoryId, LanguageEnum language, String name) {
    ...
    default Optional<FilterPointEntity> findByCategoryAndUnitName_LocaleAndUnitName_Text(Integer categoryId, LanguageEnum language, String unitName) {
        if (LanguageEnum.EN.equals(language)) {
