 ...
 */
@Component
public class MultiLevelRate implements Command {
    ...
    public LevelResponse runCommand(Update update, Level level, User users) throws CloneNotSupportedException {
        ...
        System.out.println();
        System.out.println("********************MultiLevelRate******************" + level.getCallName());
        System.out.println();
        System.out.println();

        //Level resultLevel = initialLevel.level_MULTI_LEVEL_RATE;
        LevelDTOWrapper resultLevel = initialLevel.convertToLevel(initialLevel.level_MULTI_LEVEL_RATE,
                true,
                false);
        ...
        if (update.getMessage() != null) {
            ...
            try {
                ...
                resultLevel = initialLevel.convertToLevel(initialLevel.level_MULTI_ACTION_LEVEL,
                        true,
                        false);
